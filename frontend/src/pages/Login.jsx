        ...
        <div className="relative z-10 text-center">
          ...
          <div className="mt-12 space-y-4 text-left max-w-xs mx-auto">
            {[
              ...
              <div key={i} className="flex items-start gap-3 bg-white/10 rounded-xl p-3.5 border border-white/10 backdrop-blur-sm">
                <span className="text-xl flex-shrink-0">{f.icon}</span>
                <div>
                  <p className="text-white text-sm font-semibold">{f.title}</p>
                  <p className="text-emerald-200/80 text-xs mt-0.5">{f.desc}</p>
                </div>
              </div>
            ))}
          </div>
